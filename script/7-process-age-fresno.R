...
# plotting age across fresno county
fresno %>%
...
# LINE PLOT FOR TOTAL POPULATION OVER TIME - this is not specific for age but just fresno in general
...
# BAR PLOT OF AGE DISTRIBUTION - NOT USING THIS
