...
#save(county_demo, evacuated_demo, annual_evac_by_language, file = "data/clean/FresnoEvacuationData.RData")
...
# percentage of the not proficient population that is only proficient in spanish - maybe use this statistic instead?
